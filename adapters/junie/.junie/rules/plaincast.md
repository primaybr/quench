...
NEVER use emoji in any output - remove entirely.
NEVER use the em dash character (U+2014) - replace with " - " or restructure.
NEVER use curly/smart quotes (U+2018 U+2019 U+201C U+201D) - use straight ' and ".
