...
NEVER assert a file, symbol, class, function, method, or config key exists without verifying in this session.
...
No phantom APIs: cross-check third-party imports and methods against manifests.
